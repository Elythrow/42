...
/*   Updated: 2026/01/09 11:59:42 by gbazin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (this->hit_points < 0)
		this->hit_points = 0;
	std::cout << "ClapTrap " << this->name << " takes " << amount << " points of damage. He now has: " << this->hit_points << " hit points." << std::endl;
	if (this->hit_points == 0)
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->hit_points <= 0)
	{
		std::cout << "ClapTrap " << this->name << " is dead he can't repair." << std::endl;
		return ;
	}
	else if (this->energy_points <= 0)
	{
	...
	this->hit_points += amount;
	this->energy_points--;
	std::cout << "ClapTrap " << this->name << " repairs itself for " << amount << " hit points. He now has " << this->hit_points << " hit points and " << this->energy_points << " energy points remaining." << std::endl;
}
