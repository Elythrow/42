...
/*   Updated: 2026/08/18 16:00:13 by gbazin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	os << "Form name: " << form.getName() << ", signed: " << form.getsignedStatus() << ", required grade to sign: " << form.getgrade2Sign() << ", required grade to execute: " << form.getgrade2Exec() << ".";
	return (os);
}
