...
/*   Updated: 2026/08/19 14:42:45 by gbazin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	os << "AForm name: " << AForm.getName() << ", signed: " << AForm.getsignedStatus() << ", required grade to sign: " << AForm.getgrade2Sign() << ", required grade to execute: " << AForm.getgrade2Exec() << ".";
	return (os);
}
